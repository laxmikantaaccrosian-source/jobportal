...
class Posted_Jobs extends CI_Controller {
	public function index(){
		...
		//Pagination starts
		$total_rows = $this->posted_jobs_model->record_count('pp_post_jobs');
		...
		$obj_result = $this->posted_jobs_model->get_opened_jobs_home_page($config["per_page"], $page);
	...
	public function jobs_by_company($employer_id=''){
		...
		//Pagination starts
		$total_rows = $this->posted_jobs_model->count_records('pp_post_jobs','employer_ID',$employer_id);
