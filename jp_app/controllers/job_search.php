...
class Job_Search extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("search-jobs/".$this->uri->segment(2)), $total_rows, 20, 3, 5, true);
		...
		$current_records = ($this->uri->segment(3)) ? intval($this->uri->segment(3)) * 20 : 20;
