...
<meta name="keywords" content="<?php echo $keyword;?> Government Jobs" />
<meta name="description" content="Search results for <?php echo $keyword;?> government jobs at <?php echo SITE_NAME;?>." />
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="candidatesection">          
          <div class="col-md-9">            
            ...
            <div class="input-group">      
              <input type="text" name="keyword" id="keyword" class="form-control" 
                     placeholder="Search by sector, post name, or keyword" 
          ...
          <div class="col-md-3">           
            <input type="button" value="Browse All Jobs" title="Government Jobs" 
                   class="postjobbtn" alt="Government Jobs" 
                   onClick="document.location='<?php echo base_url('government-jobs');?>'" />
            <div class="clear"></div>
          </div>            
          <div class="clear"></div>
        </div>
...
<!--Government Jobs Search Results-->
  ...
  <div class="row"> 
    ...
    <div class="col-md-10"> 
      ...
      <div class="search-keyword">
        <strong>Search Results for:</strong> "<?php echo $keyword;?>"
      </div>
      ...
      <div class="searchpage">
        <div class="toptitlebar">
          <div class="row">
            <div class="col-md-6"><b>Government Jobs - Search Results</b></div>
            <div class="col-md-6 text-right">
              <strong>Results <?php echo $from_record.' - '.$page;?> of <?php echo $total_rows;?></strong>
            </div>
          </div>
        </div>
        ...
        <div class="govt-job-card">
          ...
          <p style="margin: 15px 0; color: #666;">
            <?php echo word_limiter(strip_tags($row->job_description), 30);?>
          </p>
          <?php endif;?>
          
          <a href="<?php echo base_url('government-jobs/detail/'.$row->slug);?>" class="view-details-btn">
            View Full Details
          </a>
        </div>
        <?php endforeach; else: ?>
        <div class="err" align="center" style="padding: 40px;">
          <p><strong>No results found for "<?php echo $keyword;?>"</strong></p>
          <p>Please try different keywords or <a href="<?php echo base_url('government-jobs');?>">browse all government jobs</a></p>
        </div>
        <?php endif;?>
      </div>
