  ...
  <div class="navbar navbar-default" role="navigation">
        <div class="col-md-2">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url();?>" title="USA jobs website"><img src="<?php echo base_url('public/images/logo2.png');?>" alt="USA jobs website" /></a> </div>
        </div>
        <div class="col-md-<?php echo ($this->session->userdata('is_user_login')==TRUE)?'6':'6';?>">
          <div class="navbar-collapse collapse">
			...
			?>
              ...
              <li <?php echo active_link('government_jobs');?>><a href="<?php echo base_url('government_jobs');?>" title="Government Jobs">Government Job</a></li>
