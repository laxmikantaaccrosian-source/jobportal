...
<div class="container">
        ...
        <ul class="employersList">
		 ...
		 ?>
          <li><a href="<?php echo base_url('company/'.(isset($row_top_employer->company_slug) ? $row_top_employer->company_slug : '#'));?>" title="Jobs in <?php echo (isset($row_top_employer->company_name) ? $row_top_employer->company_name : 'Unknown Company');?>"><img src="<?php echo base_url('public/uploads/employer/thumb/'.$company_image_name);?>" alt="<?php echo base_url('company/'.(isset($row_top_employer->company_slug) ? $row_top_employer->company_slug : '#'));?>" /></a></li>
          <?php
		  		endforeach;
			endif;
		  ?>
          ...
          <ul class="row joblist">
            <?php	
	  		...
	  		foreach($latest_jobs_result as $row_latest_jobs):
				...
				$image_name = isset($row_latest_jobs->company_logo)?$row_latest_jobs->company_logo:'no_logo.jpg';
	  ?>
            <li class="col-md-6">
              <div class="intlist">
                <div class="col-xs-2"><a href="<?php echo base_url('company/'.(isset($row_latest_jobs->company_slug) ? $row_latest_jobs->company_slug : '#'));?>" title="Jobs in <?php echo (isset($row_latest_jobs->company_name) ? $row_latest_jobs->company_name : 'Unknown Company');?>" class="thumbnail"><img src="<?php echo base_url('public/uploads/employer/thumb/'.$image_name);?>" alt="<?php echo base_url('company/'.(isset($row_latest_jobs->company_slug) ? $row_latest_jobs->company_slug : '#'));?>" /></a></div>
                <div class="col-xs-6"> <a href="<?php echo base_url('jobs/'.$row_latest_jobs->job_slug);?>" class="jobtitle" title="<?php echo $row_latest_jobs->job_title;?>"><?php echo $job_title;?></a> <span><a href="<?php echo base_url('company/'.(isset($row_latest_jobs->company_slug) ? $row_latest_jobs->company_slug : '#'));?>" title="Jobs in <?php echo (isset($row_latest_jobs->company_name) ? $row_latest_jobs->company_name : 'Unknown Company');?>"><?php echo (isset($row_latest_jobs->company_name) ? $row_latest_jobs->company_name : 'Unknown Company');?></a> &nbsp;-&nbsp; <?php echo $row_latest_jobs->city;?></span> </div>
                <div class="col-xs-4"> <a href="<?php echo base_url('jobs/'.$row_latest_jobs->job_slug.'?apply=yes');?>" class="applybtn" title="<?php echo (isset($row_latest_jobs->industry_name) ? $row_latest_jobs->industry_name : 'N/A').' Job in '.$row_latest_jobs->city;?>">Apply Now</a> </div>
                <div class="clear"></div>
              </div>
            </li>
            <?php
    ...
    <div class="titlebar"> <h2>Featured Jobs</h2></div>
    	<ul class="featureJobs row">
          ...
          <li class="col-md-6">
            ...
            <a href="<?php echo base_url('jobs/'.$row_featured_job->job_slug);?>" title="<?php echo $row_featured_job->job_title;?>"><?php echo $row_featured_job->job_title;?></a> <span><a href="<?php echo base_url('company/'.(isset($row_featured_job->company_slug) ? $row_featured_job->company_slug : '#'));?>" title="Jobs in <?php echo (isset($row_featured_job->company_name) ? $row_featured_job->company_name : 'Unknown Company');?>"><?php echo (isset($row_featured_job->company_name) ? $row_featured_job->company_name : 'Unknown Company');?></a> &nbsp;-&nbsp; <?php echo $row_featured_job->city;?></span> </div>
